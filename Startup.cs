...
using ECP.Infrastructure.Services;
...
namespace EmployeeChurnPredictive
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ECPDbContext>(options =>
            ...
            // Add prediction services.
            services.AddTransient<IPredictionService, PredictionService>();

            //Get Prediction model options
            services.Configure<PredictionOptions>(Configuration.GetSection("PredictionOptions"));
